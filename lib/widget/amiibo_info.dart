...
class AmiiboDetailInfo extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ref.watch(detailAmiiboProvider(key)).when(
          ...
          data: (amiiboRoot) {
            if (amiiboRoot == null) return const SizedBox();
            final amiibo = amiiboRoot.details;
            return Column(
              ...
              children: <Widget>[
                ...
                if (amiibo.eu != null)
                  RegionDetail(amiibo.eu!, NetworkIcons.eu, translate.eu),
                if (amiibo.na != null)
                  RegionDetail(amiibo.na!, NetworkIcons.na, translate.na),
                if (amiibo.jp != null)
                  RegionDetail(amiibo.jp!, NetworkIcons.jp, translate.jp),
              ],
            );
          },
          error: (_, __) => Center(
