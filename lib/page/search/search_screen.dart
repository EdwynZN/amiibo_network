    ...
    final amiiboCategory = ref.watch(
      queryProvider.select<String>(
        (value) =>
            ...
            value.categoryAttributes.category.name,
      ),
    );
    return Scaffold(
      body: CustomScrollView(
        slivers: <Widget>[
          SliverFloatingBar(
            ...
            pinned: true,
            leading: IconButton(
              icon: Hero(tag: 'MenuButton', child: const BackButtonIcon()),
...
class _Suggestions extends HookConsumerWidget {
  ...
  const _Suggestions({Key? key, required this.textEditingController})
    : super(key: key);
      ...
      children: <Widget>[
        Expanded(
          child: OutlinedButton.icon(
            style: OutlinedButton.styleFrom(
              foregroundColor: _search == SearchCategory.Name
              ...
              backgroundColor: _search == SearchCategory.Name
                  ? _accentColor
                  : null,
            ),
            onPressed: () => _selectCategory(ref, SearchCategory.Name),
            icon: const Icon(Icons.group, size: _iconSize),
            label: FittedBox(
        ...
        Expanded(
          child: OutlinedButton.icon(
            ...
            icon: const Icon(Icons.games, size: _iconSize),
            label: FittedBox(
        ...
        Expanded(
          child: OutlinedButton.icon(
            style: OutlinedButton.styleFrom(
              ...
              backgroundColor: _search == SearchCategory.AmiiboSeries
                  ? _accentColor
                  : null,
            ),
            onPressed: () => _selectCategory(ref, SearchCategory.AmiiboSeries),
            icon: const Icon(Icons.nfc, size: _iconSize),
            label: FittedBox(
