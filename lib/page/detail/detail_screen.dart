...
import 'package:amiibo_network/shared/widget/game_list.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
            ...
            child: Material(
              ...
              child: Column(
                children: showOwnerCategories
                    ? const [AmiiboCard(), Gap(12.0), UserPreferenceCard()]
                    : const [_AmiiboCard()],
              ),
            ),
          ),
          const Expanded(child: CustomScrollView(slivers: [GameListWidget()])),
        ],
      );
    } else {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: const [AmazonAffiliationIconButton(), Gap(8.0)],
      ),
      body: body,
    );
  }
