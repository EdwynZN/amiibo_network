...
class WishedOutlinedButton extends ConsumerWidget {
  ...
  WishedOutlinedButton({Key? key, required this.amiibo, required this.isLock})
    : isActive =
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final preferencesPalette = Theme.of(
      context,
...
class OwnedOutlinedButton extends ConsumerWidget {
  ...
  OwnedOutlinedButton({Key? key, required this.amiibo, required this.isLock})
