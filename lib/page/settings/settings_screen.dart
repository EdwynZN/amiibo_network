  ...
  Widget build(BuildContext context) {
    return _ListSettings(
      ...
      onTap: () async {
        ...
        final List<String> figures = isFiguresShown
            ? filter.customFigures.toList()
            : [];
        final List<String> cards = isCardsShown
            ? filter.customCards.toList()
            : [];
        bool save =
...
class _ListSettings extends StatelessWidget {
  ...
  _ListSettings({required this.title, this.subtitle, this.icon, this.onTap});
